...
class WebSocketClient:
    ...
    async def connect(self):
        ...
        try:
            ...
            logger.info(
                ...
                extra={"service": self.service_name, "url": self.url},
            )
    ...
    async def send_message(
        self, message: Dict[str, Any], correlation_id: str, message_type: str = "chat"
    ) -> None:
    ...
    async def register_handler(
        self, message_type: str, handler: Callable[[Dict[str, Any], str], None]
    ) -> asyncio.Future:
