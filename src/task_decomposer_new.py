            ...
            return {
                "subtasks": [
                    ...
                    },
                    {
                        ...
                        "description": "Analyze sentiment in extracted text",
    ...
    async def decompose(
        ...
        try:
            ...
            prompt = self.prompt_template.format(
                task_type=task_type, content=content, context=context or {}
            )
            ...
            if task_type == "document_analysis":
                ...
                return TaskDecomposition(
                    subtasks=[
                        SubTask(
                            service="web_scraper", description="Scrape content from URL"
                        ),
                        SubTask(
                            service="content_analyzer",
                            description="Analyze scraped content",
                ...
                raise ValueError(
                    f"No fallback workflow available for task type: {task_type}"
                )
