...
class TaskDecomposer:
    ...
    async def _decompose_document_analysis(
                ...
                SubTask(
                    ...
                    content={
                        "messages": [
                            ...
                            {"role": "user", "content": "$result.pdf_extraction.text"},
                        ],
                        "context": {
        ...
        return TaskDecomposition(
            subtasks=subtasks, metadata={"priority": context.get("priority", "normal")}
        )
    ...
    async def _decompose_chat_with_context(
        ...
        return TaskDecomposition(
            subtasks=subtasks, metadata={"session_id": content.get("session_id")}
        )
    ...
    async def _decompose_web_research(
        ...
        return TaskDecomposition(subtasks=subtasks, metadata={"url": content["url"]})
    ...
    async def _decompose_sentiment_analysis(
        ...
        return TaskDecomposition(subtasks=subtasks, metadata={})
